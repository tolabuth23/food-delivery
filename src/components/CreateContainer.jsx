...
const CreateContainer = () => {
  ...
  const saveDetails =()=>{
    ...
    try {
      if (!title || !calories || !imageAsset || !price || !category){
        console.log("The book is not good!!!!");
        setFields(true);
  ...
  return (
    <div
    className='w-full min-h-screen h-auto flex justify-center items-center'>
    ...
    flex flex-col items-center justify-center '>
      {fields && (
        ...
        border-dotted border-gray-300 w-full h-225 md:h-420 mt-4
        ...
        >
          ...
          <div className='w-full flex flex-col md:flex-row items-center gap-3'>
            ...
            border-none placeholder:  text-textColor"></input>
          </div>
          <div className='w-full py-2 border-b border-gray-300 flex
            items-center gap-2'>
          ...
          <div className='flex items-center w-full'>
            ...
            outline-non bg-emerald-500 px-12 py-2 rounded-lg text-lg
